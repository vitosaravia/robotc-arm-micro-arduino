...
int Grados_2 = 60;  // posición servo_2
...
// Pines para los botones de los joysticks (switches)
#define button_open 4   // abre la pinza
#define button_close 5  // cierra la pinza
...
void setup() {
  ...
  servo_5.attach(8);  // salida pwm pin 5
...
void loop() {
  ...
  if (Joystick1_X_valor < 340) Grados_1 += 10;
  else if (Joystick1_X_valor > 680) Grados_1 -= 10;

  if (Joystick1_Y_valor < 340) Grados_2 += 10;
  else if (Joystick1_Y_valor > 680) Grados_2 -= 10;

  if (Joystick2_X_valor < 340) Grados_5 += 40;
  else if (Joystick2_X_valor > 680) Grados_5 -= 40;

  if (Joystick2_Y_valor < 340) Grados_4 += 10;
  else if (Joystick2_Y_valor > 680) Grados_4 -= 10;

  // Control de pinza con botones del joystick
  if (digitalRead(button_open) == LOW) {
    Grados_3 += 5;  // abrir pinza
  } 
  if (digitalRead(button_close) == LOW) {
    Grados_3 -= 5;  // cerrar pinza
  }
  ...
  Grados_5 = min(180, max(0, Grados_5)); // Angulos maximos y minimos de servo 4
  ...
  Serial.print("Grados eje 1 : "); Serial.println(Grados_1);
  Serial.print("Grados eje 2 : "); Serial.println(Grados_2);
  Serial.print("Grados eje 3 : "); Serial.println(Grados_3);
  Serial.print("Grados eje 4 : "); Serial.println(Grados_4);
  Serial.print("Grados eje 5: ");  Serial.println(Grados_5);
  Serial.print("\n");
